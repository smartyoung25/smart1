...
_VPD_OPTIMAL: dict[str, dict[str, tuple[float, float]]] = {
    ...
    # 오이: 고온다습 선호(RDA 시설오이 습도 70~85%) → 딸기와 유사한 저VPD 밴드.
    #   구: _VPD_OPTIMAL에 누락되어 방울토마토(0.8~1.4)로 폴백됐다. E2E 2026-08-07.
    "오이":     {"early": (0.4, 0.8), "mid": (0.5, 1.0), "late": (0.5, 0.9)},
}
...
_SEASON_STAGES: dict[str, dict[str, list[int]]] = {
    ...
    "오이":     {"early": [6, 7],     "mid": [8, 9, 10],      "late": [11, 12, 1]},
}
