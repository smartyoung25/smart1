...
from fastapi import Depends, HTTPException, Query, Body, UploadFile, File
from pydantic import BaseModel, Field
from typing import Optional
from api.middleware.auth import require_auth
from api.routers.farmer_state import (  # noqa: F401 — shared state + router
    _FARM_META, _FARM_ENV, _require_farm, router, _verify_farm_ownership,
)
...
# ---------------------------------------------------------------------------
# _verify_farm_ownership / router → api/routers/farmer_state.py
# Farm registry / _FARM_META / _FARM_ENV → api/routers/farmer_state.py
# ---------------------------------------------------------------------------
