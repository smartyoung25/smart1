...
### ★ 신규 기능: 평년 대비 외부기상 (ERA5 climatology)
- `api/services/climatology.py`+`GET /environment/climatology`: 작물 주산지 ERA5(2018~2022) 월별 평년값(기온·일사·강수·GDD)
- G2 환경제어 카드: 평년4지표+현재외기 대비편차(냉난방부하 시사)+주산지·출처. 미지원작물 자동숨김
- 6작물 전부 보유: 딸기·참외·방울토마토·완숙토마토·오이·파프리카. 페처 `scripts/fetch_era5_openmeteo.py`(주산지 좌표)
