...
# 작목별 시설 완비도 계수 — 40농가 소득조사표 실측 재산정
# (scripts/_build_facility_factor_dataset.py, base 0.60 + 설치시설 CAPEX가중, 고장=0.5).
# ★ 초기 4샘플 추정(딸기1.00·방울0.92·완숙0.82·참외0.70)을 실측 분포로 대체.
#   완숙은 단일샘플이 측창·관수 결여였으나 10농가 분포는 대부분 완비(0.94).
_CROP_FACILITY_FACTOR = {
    "딸기": 0.934, "방울토마토": 0.910, "완숙토마토": 0.940, "참외": 0.712,
}
