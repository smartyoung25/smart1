...
### ✅ 실증 (2026-06-04) — M2 VPD+월주기성 feature 효과 확인
- 딸기 월별(env+prod) 1248행·**농장그룹 61개** GroupKFold 실험.
- 베이스라인 vs +VPD(Magnus)+월 sin/cos: **CV MAPE 일관 개선(+13.6%p)**.
- (절대 MAPE는 0수확 초기월 포함으로 과대; 프로덕션 stage2 필터/집계와 달라 *방향성*이 핵심)
- **권고: 다음 stage2 재학습 시 feature build에 vpd·m_sin·m_cos 편입** (효과 검증됨, 전 작물 적용).
