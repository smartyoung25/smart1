...
## 성능 측정 (Lighthouse · c3_home · mobile · 2026-06-01, 개선 후)
| 지표 | 개선전 | 개선후 | 정책목표 | 판정 |
|------|--------|--------|----------|------|
| 성능 점수 | 87 | **100** | — | 🟢 |
| 접근성 | 81 | **94** | WCAG AA | 🟢 |
| LCP | 1.5s | 1.5s | <3.0s | 🟢 PASS |
| CLS | 0.228 | **0** | <0.1 | 🟢 PASS |
| TBT | 110ms | **20ms** | <200ms | 🟢 PASS |

개선: --muted 대비 강화 · farmSel aria-label · KPI/To-do min-height(CLS 제거) · Period 뱃지 색상 대비
잔여: color-contrast 1건(미세 — 추후 보강)
