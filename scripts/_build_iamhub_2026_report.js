...
const summary = [
  ...
  P('한편 계획 대비 미이행 항목이 존재한다. 경영비 이상치 탐지·알림 서비스, 주간/일일 작업추천 시스템, RFID 활용방안은 미착수이며, CAPEX/OPEX 구분에 따른 다년 ROI 추정은 부분 이행 상태이다. 또한 보안조치 이행계획 중 개인정보 비식별화·암호화는 미적용 상태로, 과업①의 소득자료 조사로 농가 개인정보가 수집되기 전까지 완료가 필요하다. 해당 항목은 제6장 잔여기간 추진계획에 반영하였다.', { after: 170 }),
