...
const ch3 = [
  ...
  B('실제로 보조 데이터(농진청 딸기 자료)에서는 환경 지표가 **품질**과 더 강한 관계를 보인다 — 누적 일사량과 당도의 상관이 +0.627로 수확량(+0.390)보다 높고, 관수량도 당도와 +0.301의 관계를 보인다. 즉 환경·관수 관리의 효과는 수확량보다 품질에서 먼저 나타날 가능성이 있으나, 본 검증의 결과 변수는 수확량뿐이었다.'),
