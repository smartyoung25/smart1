...
c = ws3.cell(row=r, column=1,
    value="생산량·시설구성·자산별 취득가(신조가격)·내용연수·사양은 조사표 '농가' 시트에 실입력(20농가 251자산 확인). "
          "다만 업체(제조사)는 거의 미기재 — 과업①에서 견적서·시방서를 조사항목에 포함하면 업체·단가 결측이 해소된다. "
          "(품목별 완비도 계수·감가는 시설구성 지표, 실 취득가 집계는 자산등록부 참조.)")
